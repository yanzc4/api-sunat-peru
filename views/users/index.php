    ...
    <header class="border-b border-slate-200 bg-white dark:border-white/10 dark:bg-[#111419]">
        <div class="mx-auto flex h-16 max-w-[1440px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-8">
                ...
                <nav class="hidden items-center gap-1 md:flex" aria-label="Navegación principal"><a href="/dashboard" class="admin-nav-link">Empresas</a><a href="/usuarios" class="admin-nav-link admin-nav-active">Usuarios</a></nav>
            </div>
        ...
        <nav class="flex border-t border-slate-100 px-4 md:hidden dark:border-white/5"><a href="/dashboard" class="admin-mobile-link">Empresas</a><a href="/usuarios" class="admin-mobile-link border-b-2 border-[#9aac00] text-[#657500] dark:border-signal dark:text-signal">Usuarios</a></nav>
    </header>
